...
int main(int argc, char *argv[])
{
    ...
    simpleqtlogger::SimpleQtLogger::getInstance()->setLogFileName(QDir::home().filePath("Documents/testSimpleQtLoggerGui.log"), 10*1000, 10);
    ...
    simpleqtlogger::SimpleQtLogger::getInstance()->setLogFileName("warn", QDir::home().filePath("Documents/testSimpleQtLoggerGuiWarn.log"), 10*1000, 10);
